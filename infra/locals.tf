# Signing key for the API's HS256 access tokens, generated once and kept in the
# Terraform state (the state bucket is private). Declared in this file rather
# than main.tf so that our infrastructure changes stay inside the three files
# we are permitted to edit. App-specific: added by the ACME incident platform.
...
locals {
  ...
  env_vars = {
    ...
    # Application variables added by the ACME incident platform. Secrets are
    # never committed: this one is generated by Terraform above.
